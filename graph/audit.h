...
#ifndef __HYPERBAN__AUDIT_H
#define __HYPERBAN__AUDIT_H

#include "types.h"

int audit_level (SavedTile *tiles, ConfigOption *options);
int audit_board (Board *board);

#endif /* __HYPERBAN__AUDIT_H */
